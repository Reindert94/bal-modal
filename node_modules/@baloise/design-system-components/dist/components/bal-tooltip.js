...
const Tooltip = proxyCustomElement(class Tooltip extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["bal-tooltip", "bal-stack"];
...
const BalTooltip = Tooltip;
const defineCustomElement = defineCustomElement$1;

export { BalTooltip, defineCustomElement };
