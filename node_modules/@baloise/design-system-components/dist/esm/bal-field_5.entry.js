...
import { f as deepReady, b as waitAfterFramePaint } from './helpers-697ce790.js';
...
const Field = class {
  ...
  async syncAriaAttributes() {
    ...
    const controls = [
      ...
      ...Array.from(this.el.querySelectorAll('bal-field-control bal-input-date')),
...
const FieldLabel = class {
  ...
  render() {
    return (h(Host, { class: "bal-field-label" }, h("bal-label", { multiline: true, size: this.size, htmlFor: this.htmlFor, required: this.required, valid: this.valid, invalid: this.invalid, disabled: this.disabled, readonly: this.readonly, weight: this.weight }, h("slot", null))));
  }
