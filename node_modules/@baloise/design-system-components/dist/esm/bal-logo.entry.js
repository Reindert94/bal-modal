  ...
  async loadAnimation() {
    return new Promise((resolve, reject) => {
      if (this.animationFunction) {
        ...
        rIC(async () => {
          import('./bal-logo.animation-8f4b09a0.js')
            .then(module => {
  ...
  render() {
    ...
    const LogoElement = this.animated
      ...
      : (this.isTouch && this.size === '') || this.size === 'small'
        ? SmallLogo
        : LargeLogo;
    return (h(Host, { class: Object.assign(Object.assign(Object.assign(Object.assign({}, logoBlock.class()), logoBlock.modifier(this.color).class()), logoBlock.modifier(`size-${this.size}`).class(this.size !== '')), logoBlock.modifier('animated').class(this.animated)) }, h(LogoElement, null)));
  }
