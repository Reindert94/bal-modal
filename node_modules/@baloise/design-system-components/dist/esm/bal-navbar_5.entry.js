import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-853c3f3f.js';
import { B as BEM } from './bem-1b28532d.js';
import { B as BalScrollHandler } from './scroll-5f7701b9.js';
import { b as balBrowser } from './browser-9199b5e2.js';
import { f as deepReady } from './helpers-697ce790.js';
import { b as balBreakpoints } from './breakpoints.subject-89817b34.js';
...
const NavbarBrand = class {
  ...
  render() {
    ...
    const logoTemplate = this.logo ? (h("img", { loading: "lazy", class: Object.assign({}, navbarBrandEl.element('logo').class()), src: this.logo, alt: "" })) : (h("bal-logo", { animated: this.animated, color: 'white', size: this.logoSize }));
