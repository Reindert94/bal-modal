...
declare namespace BalEvents {
  ...
  interface BalInputDateCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLBalInputDateElement;
  }
  type BalInputDateInputDetail = string | undefined;
  type BalInputDateInput = BalInputDateCustomEvent<BalInputDateInputDetail>;
  type BalInputDateChangeDetail = string | undefined;
  type BalInputDateChange = BalInputDateCustomEvent<BalInputDateChangeDetail>;
  type BalInputDateBlurDetail = FocusEvent;
  type BalInputDateBlur = BalInputDateCustomEvent<BalInputDateBlurDetail>;
  type BalInputDateKeyPressDetail = KeyboardEvent;
  type BalInputDateKeyPress = BalInputDateCustomEvent<BalInputDateKeyPressDetail>;
  type BalInputDateFocusDetail = FocusEvent;
  type BalInputDateFocus = BalInputDateCustomEvent<BalInputDateFocusDetail>;
}
