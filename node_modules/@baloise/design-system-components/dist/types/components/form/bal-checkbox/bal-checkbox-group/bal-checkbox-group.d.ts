...
import { BalFocusObserver } from '../../../../utils/focus';
export declare class CheckboxGroup implements ComponentInterface, Loggable, BalMutationObserver, BalAriaFormLinking, BalFocusObserver {
  private inputId;
