...
declare namespace BalEvents {
  ...
  type BalInputStepperBlur = BalInputStepperCustomEvent<BalInputStepperBlurDetail>;
  type BalInputStepperFocusDetail = FocusEvent;
  type BalInputStepperFocus = BalInputStepperCustomEvent<BalInputStepperFocusDetail>;
}
