...
const index$1 = require('./index-d8c4556e.js');
...
const BalCard = class {
  ...
  get colorTypeClass() {
    return index$1.lodash_isempty(this.color) ? '' : `is-${this.inverted ? 'blue' : this.color}`;
  }
  render() {
    return (index.h(index.Host, { class: {
        'bal-card': true,
        [`bal-card--${this.colorTypeClass}`]: !index$1.lodash_isempty(this.color),
