...
class PopoverVariantRenderer extends AbstractVariantRenderer {
  ...
  async present(component) {
    ...
    if (component.trigger && component.containerEl && component.arrowEl) {
      ...
      if (this.triggerEl) {
        ...
        this.cleanup = floatingUi_dom_esm.autoUpdate(this.triggerEl, component.containerEl, () => {
  ...
  async update(component) {
    ...
    if (this.triggerEl && component.trigger && component.containerEl && component.arrowEl) {
      ...
      floatingUi_dom_esm.computePosition(this.triggerEl, component.containerEl, {
        placement: this.placement,
        middleware: [
          floatingUi_dom_esm.shift(),
          floatingUi_dom_esm.flip(),
          floatingUi_dom_esm.offset(this.arrow ? 16 : this.offset),
