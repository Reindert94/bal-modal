...
const FieldLabel = class {
  ...
  render() {
    return (index.h(index.Host, { class: "bal-field-label" }, index.h("bal-label", { multiline: true, size: this.size, htmlFor: this.htmlFor, required: this.required, valid: this.valid, invalid: this.invalid, disabled: this.disabled, readonly: this.readonly, weight: this.weight }, index.h("slot", null))));
  }
