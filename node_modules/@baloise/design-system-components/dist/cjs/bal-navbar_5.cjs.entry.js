...
const scroll = require('./scroll-557c6ead.js');
...
const NavbarBrand = class {
  ...
  render() {
    ...
    const logoTemplate = this.logo ? (index.h("img", { loading: "lazy", class: Object.assign({}, navbarBrandEl.element('logo').class()), src: this.logo, alt: "" })) : (index.h("bal-logo", { animated: this.animated, color: 'white', size: this.logoSize }));
