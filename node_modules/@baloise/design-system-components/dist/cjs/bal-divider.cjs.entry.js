...
const BalDivider = class {
  ...
  render() {
    const block = bem.BEM.block('divider');
    const layout = !!this.layout;
    const space = !!this.space;
    const color = !!this.color;
    return (index.h(index.Host, { role: "separator", class: Object.assign(Object.assign(Object.assign(Object.assign({}, block.class()), block.modifier(`layout-${this.layout}`).class(layout)), block.modifier(`space-${this.space}`).class(space)), block.modifier(`color-${this.color}`).class(color)) }, index.h("slot", null)));
  }
};
__decorate([
  log.Logger('bal-divider')
], BalDivider.prototype, "createLogger", null);
BalDivider.style = {
  css: balDividerCss
};

exports.bal_divider = BalDivider;
