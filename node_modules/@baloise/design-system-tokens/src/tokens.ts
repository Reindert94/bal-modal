export const BaloiseDesignToken = {
  ...
  balColorSuccess3Inverted: '#ffffff',
  ...
  balColorWarning5Inverted: '#000d6e',
  balColorWarning6Inverted: '#000d6e',
  balColorDanger1Inverted: '#000d6e',
  balColorDanger2Inverted: '#000d6e',
  balColorDanger3Inverted: '#ffffff',
  ...
  balColorInfoInverted: '#ffffff',
  balColorSuccessInverted: '#ffffff',
  balColorWarningInverted: '#000d6e',
  balColorDangerInverted: '#ffffff',
  balColorTextPrimary: '#000d6e',
  balColorTextPrimaryInverted: '#ffffff',
  balColorTextWhite: '#ffffff',
  balColorTextWhiteInverted: '#000d6e',
  balColorTextBlack: '#000000',
  balColorTextBlackInverted: '#ffffff',
  balColorTextGreyDark: '#313131',
  balColorTextGreyDarkInverted: '#ffffff',
  balColorTextGrey: '#747474',
  balColorTextGreyInverted: '#ffffff',
  balColorTextGreyLight: '#b6b6b6',
  balColorTextGreyLightInverted: '#000d6e',
  balColorTextLightBlue: '#0014aa',
  balColorTextLightBlueInverted: '#ffffff',
  balColorTextLightBlueLight: '#a7d1fa',
  balColorTextLightBlueLightInverted: '#000d6e',
  balColorTextInfoLight: '#60a0e0',
  balColorTextInfoLightInverted: '#ffffff',
  balColorTextPrimaryDark: '#000739',
  balColorTextPrimaryDarkInverted: '#ffffff',
  balColorTextPrimaryLight: '#656ea8',
  balColorTextPrimaryLightInverted: '#000d6e',
  balColorTextSuccess: '#168741',
  balColorTextSuccessInverted: '#ffffff',
  balColorTextInfo: '#1c77d2',
  balColorTextInfoInverted: '#ffffff',
  balColorTextWarning: '#f99319',
  balColorTextWarningInverted: '#000d6e',
  balColorTextDanger: '#ea1800',
  balColorTextDangerInverted: '#ffffff',
  balColorTextDangerDark: '#cb1501',
  balColorTextDangerDarkInverted: '#ffffff',
  balColorTextDangerDarker: '#a01100',
  balColorTextDangerDarkerInverted: '#ffffff',
  balColumnGap: '1rem',
  balRadiusNone: '0',
